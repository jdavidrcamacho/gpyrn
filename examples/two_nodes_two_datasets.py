...
nodes = [kernels.Periodic(1, 31, 0.5), kernels.Matern52(1, 100)]
weight = [
    kernels.SquaredExponential(20, 5),
    kernels.SquaredExponential(0.1, 10),
    kernels.SquaredExponential(10, 5),
    kernels.SquaredExponential(1, 10),
]
...
a, _, b = gprn.predict_from_variational_parameters(
