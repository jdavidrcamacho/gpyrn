"""Gaussian-process helper used for component predictions."""
...
class GaussianProcess:
    """Gaussian-process predictor for one latent component.

    Args:
        time: Training time coordinates.
        y: Training measurements.
        yerr: Optional measurement uncertainties.
    """
    ...
    def new_kernel(self, kernel, new_pars):
        """Create a copy of a kernel with updated parameters.
    ...
    def prediction(self, kernel, time, m, v):
        ...
        Args:
            ...
            m: Variational mean values at the training times.
            v: Variational variance values at the training times.

        Returns:
            Predictive mean and variance vectors.
        """
